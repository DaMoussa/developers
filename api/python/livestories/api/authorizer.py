...
class Authorizer():
    """
    Creates the authorization string required to sign any request to the Partner API (Authenticated)

    """
    def __init__(self, api_key, secret):
        """

        :param api_key: the name of the key as shown in your Team page.
        :param secret: the secret corresponding to this key as shown in your Team page.

        """
        self.api_key = api_key  # per team key, available on LiveStories platform
        self.secret = secret  #
        self.scope = 'collection_full'  # reserved
        self.service = 'burp'  # reserved
